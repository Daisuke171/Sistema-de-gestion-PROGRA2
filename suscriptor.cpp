...
void Subscriptor::setNacimiento(const Fecha &nacimiento){ ///const para evitar que el objeto se modifique, y referencia para evitar que se hagan copias innecesarias
...
Subscriptor::Subscriptor()
{
    ...
    _telefono[0] = '\0';
    _email[0] = '\0';
    _nacimiento = Fecha(0,0,0);
}

Subscriptor::Subscriptor(int id, int dni, std::string nombre, std::string apellido, std::string telefono, std::string email, Fecha nacimiento){
    setId(id);
    setDni(dni);
    setNombre(nombre);
